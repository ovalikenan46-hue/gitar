                  ...
                  <AnimatePresence key={i}>
                    {visible && (
                      <motion.div
                        ...
                        style={{ left: `${xPct}%`, top: `${yPct}%`, background: color, boxShadow: `0 2px 10px ${color}88` }}
                      >
                        {f.finger}
                      </motion.div>
                    )}
        ...
        <AnimatePresence>
          {lightboxOpen && (
            <motion.div
              ...
              transition={{ duration: 0.2 }} onClick={closeLightbox}
            >
              <motion.div
              ...
              <motion.button
                ...
                transition={{ delay: 0.1 }} onClick={closeLightbox} aria-label="Kapat"
              >
